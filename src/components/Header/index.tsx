	...
	return (
		<header className="fixed left-0 top-0 z-50 w-full bg-[#211F28] py-2">
			<nav className="container flex items-center justify-between gap-3">
				...
				<ul
					className={twMerge(
						"absolute left-full top-0 z-10 flex h-auto w-full flex-col items-center justify-end gap-4 bg-[#211F28] py-5 text-2xl duration-300 lg:static lg:flex-row",
						active &&
							"left-0  h-screen w-screen flex-col justify-center",
					)}
				>
					<li
				...
				<button
					...
					className={twMerge(
						"relative h-6 w-8 before:absolute before:left-0 before:top-0 z-50 before:h-0.5 before:w-full before:origin-[left_center] before:bg-white before:duration-150 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-full after:origin-[left_center] after:bg-white after:duration-150 lg:hidden",
