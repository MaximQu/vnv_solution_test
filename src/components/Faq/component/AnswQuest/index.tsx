...
const asnwerStyles =
	"relative text-xl font-semibold pr-7 before:absolute before:rounded-[100%] after:rounded-[100%] before:right-0 before:top-3 before:h-1 before:w-5 before:bg-white after:absolute cursor-pointer after:right-0 after:top-3 after:h-1 after:w-5 after:rotate-90 after:bg-white before:duration-200 after:duration-200 duration-200";
