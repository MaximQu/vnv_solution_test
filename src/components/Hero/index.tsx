...
const Hero = () => {
	return (
		<section className="relative isolate flex flex-col justify-center bg-[url('/images/hero-bg.jpg')] h-[100svh] bg-cover bg-fixed bg-center px-0 before:absolute before:inset-0 before:-z-10 before:h-full before:w-full before:bg-black/30 md:p-5">
